...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(LuaHuiDiao.CsCallLua))
			{
			    return new LuaHuiDiao.CsCallLua(__Gen_Delegate_Imp2);
			}
		
		    if (type == typeof(TouchSlide.CsCallLua_Move))
			{
			    return new TouchSlide.CsCallLua_Move(__Gen_Delegate_Imp2);
			}
		    ...
		    if (type == typeof(LuaHuiDiao.CsCallLua_MouseClick))
			{
			    return new LuaHuiDiao.CsCallLua_MouseClick(__Gen_Delegate_Imp11);
			}
