...
namespace XLua.CSObjectWrap
{
    ...
    public class ShuaiFrameworkSpriteResWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ShuaiFramework.SpriteRes);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					ShuaiFramework.SpriteRes gen_ret = new ShuaiFramework.SpriteRes();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ShuaiFramework.SpriteRes constructor!");
        ...
        static int _g_get_spriteList(RealStatePtr L)
        {
		    try {
                ...
                ShuaiFramework.SpriteRes gen_to_be_invoked = (ShuaiFramework.SpriteRes)translator.FastGetCSObj(L, 1);
