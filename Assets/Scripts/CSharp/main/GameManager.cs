...
public class GameManager : MonoBehaviour
{
    ...
    {
        //string absPath = @Application.dataPath + "/Scripts/lua/" + filePath + ".lua";
        string absPath = @"D:\IDE\WorkSpace\WorkSpace_Unity\WorkSpace_Unity_All\2048\Assets\Scripts\lua\" + filePath + ".lua";
